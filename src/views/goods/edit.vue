  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="集团价格" prop="groupPrice">
          <el-input v-model="goods.groupPrice" placeholder="0.00">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="京猫均价" prop="jmAvgPrice">
          <el-input v-model="goods.jmAvgPrice" placeholder="0.00">
            <template slot="append">元</template>
          </el-input>
        </el-form-item> -->
        ...
        <el-form-item label="关键字">
          ...
          <el-button v-else class="button-new-keyword" size="small" type="primary" @click="showInput">+ 增加
          </el-button>
        </el-form-item>
      ...
      <el-dialog :visible.sync="specVisiable" title="设置规格">
        <el-form ref="specForm" :rules="rules" :model="specForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
          ...
          <el-form-item label="规格图片" prop="picUrl">
            <el-upload :headers="headers" :action="uploadPath" :show-file-list="false" :on-success="uploadSpecPicUrl" class="avatar-uploader" accept=".jpg,.jpeg,.png,.gif">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="jmAvgPrice" width="100" label="京猫均价" />
        <el-table-column property="groupPrice" width="100" label="集团价格" />
        <el-table-column property="price" width="100" label="当前价格" />
        <el-table-column property="counterPrice" width="100" label="专柜价格" />
      ...
      <el-dialog :visible.sync="productVisiable" title="设置货品">
        <el-form ref="productForm" :model="productForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
          ...
          <el-form-item label="专柜价格" prop="counterPrice">
            <el-input v-model="productForm.counterPrice" />
          </el-form-item>
          <el-form-item label="京猫均价" prop="jmAvgPrice">
            <el-input v-model="productForm.jmAvgPrice" />
          </el-form-item>
          <el-form-item label="集团价格" prop="groupPrice">
            <el-input v-model="productForm.groupPrice" />
          </el-form-item>
          ...
          <el-form-item label="货品图片" prop="url">
            <el-upload :headers="headers" :action="uploadPath" :show-file-list="false" :on-success="uploadProductUrl" class="avatar-uploader" accept=".jpg,.jpeg,.png,.gif">
...
export default {
    ...
    methods: {
        ...
        uploadPicUrl: function (response) {
            this.$set(this.goods, 'picUrl', response.data.url);
        },
        ...
        specToProduct() {
            ...
            do {
                ...
                products[productsIndex] = {
                    ...
                    price:
                        this.products[productsIndex] && this.products[productsIndex].price
                            ? this.products[productsIndex].price
                            : 0,
                    number:
                        this.products[productsIndex] && this.products[productsIndex].number
                            ? this.products[productsIndex].number
                            : 0,
                    url: '',
                };
                productsIndex++;
