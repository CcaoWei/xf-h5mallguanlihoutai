    ...
    <div class="app-container">
        ...
        <div class="filter-container">
            ...
            <el-input
                ...
                placeholder="请输入类目名称"
            /> -->
            <el-input v-model="listQuery.supplierName" clearable class="filter-item" style="width: 200px;"
        ...
        <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit
            ...
            <el-table-column align="center" min-width="100" label="统一社会信用编码" prop="creditCode" />
            <el-table-column align="center" min-width="100" label="法定代表人" prop="legalUser" />
