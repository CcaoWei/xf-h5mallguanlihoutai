<template>
    <div class="app-container">
        ...
        <div class="filter-container">
            ...
            />
            <el-button
                v-permission="['GET /admin/groupon/list']"
                class="filter-item"
                type="primary"
                icon="el-icon-search"
                @click="handleFilter"
        ...
        >
            ...
            <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button
                        v-permission="['POST /admin/groupon/update']"
                        type="primary"
                        size="mini"
                    ...
                    >
                    <el-button
                        v-permission="['POST /admin/groupon/delete']"
                        type="danger"
                        size="mini"
