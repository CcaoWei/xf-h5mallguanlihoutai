...
{
    path: '/enterprise',
    component: () => import('@/views/register/enterprise'),
    hidden: true,
},
{
    path: '/agreement',
...
{
    path: '/approval',
    component: () => import('@/views/supplier/approval'),
    hidden: true,
},
{
    path: '/auth-redirect',
...
//     path: '/purchaser',
//     component: Layout,
//     redirect: 'purchaser/purchaser',
//     alwaysShow: true,
//     name: 'purchaser',
//     meta: {
//         title: '采购商管理',
//         icon: 'caigoushangguanli',
//     },
//     children: [{
//         path: 'purchaser',
//         component: () => import('@/views/purchaser/purchaser'),
//         name: 'purchaser',
//         meta: {
//             title: '采购商列表',
//             noCache: true,
...

{
    ...
    children: [
        //     {
        //     path: 'invite',
        //     component: () => import('@/views/stat/invite'),
        //     name: 'statInvite',
        //     meta: {
        //         perms: ['GET /admin/stat/invite'],
        //         title: '邀请统计',
        //         noCache: true,
        //     },
        // },
